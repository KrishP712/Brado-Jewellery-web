...
const MensBraclet = () => {
    ...
    const mensBraceletData = products?.filter((product) => product.categoryName === "Men's Bracelet");
    ...
    // Update arrows based on swiper state
    ...
    // Initialize custom navigation refs
    useEffect(() => {
    ...
    return (
        <div className="sm:w-[87%] mx-auto py-8 w-[95%]">
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-18px md:text-[21px] font-medium section-title">Men’s Bracelet</h2>
            ...
            <div className="relative">
                {mensBraceletData && mensBraceletData.length > 0 ? (
                    <Swiper
                        modules={[Navigation]}
                        onSwiper={(swiper) => {
