...
const Juda = () => {
    ...
    const judaData = products?.filter((product) => product.categoryName === "Juda");
    useEffect(() => {
    ...
    return (
        <div className="sm:w-[87%] mx-auto py-8 w-[95%]">
            ...
            <div className="flex justify-between mb-4 p-[10px]">
                <h2 className="text-18px md:text-[21px] font-medium section-title">Juda</h2>
